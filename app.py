...
app.layout = dbc.Container(
    [
        ...
        dcc.Interval(
            id="interval_component", interval=1 * 100, max_intervals=1
        ),
...
@callback(
    Output("links_store", "data"), Input("interval_component", "n_intervals")
)
...
if __name__ == "__main__":
    ...
    app.run_server(
        port=port, debug=True, dev_tools_ui=True, dev_tools_props_check=True
    )
